  ...
  return (
    <div className='text-richblack-5'>
      ...
      <section className='w-full bg-richblack-800'>
        <div className='w-11/12 mx-auto max-w-maxContent flex flex-col gap-y-3 py-10'>
          ...
          <div className='flex flex-row gap-5 mt-3'>
            {
              tab.map((link, index)=>(
                <button key={index}
                  className={`${link.title === active ? "text-yellow-100 border-b border-b-yellow-100" : "text-richblack-400"}`}
